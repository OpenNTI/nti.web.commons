...
describe('getInnerStylesForAlignment', () => {
	test('Max Width Only, No Arrow', () => {
		const styles = getInnerStylesForAlignment({maxWidth: 50}, false, VERTICAL);
	...
	test('Max Width Only, With Arrow', () => {
		const styles = getInnerStylesForAlignment({maxWidth: 50}, true, VERTICAL);
	...
	test('Max Height Only, No Arrow', () => {
		const styles = getInnerStylesForAlignment({maxHeight: 50}, false, VERTICAL);
	...
	test('Max Height Only, With Arrow', () => {
		const styles = getInnerStylesForAlignment({maxHeight: 50}, true, VERTICAL);
	...
	test('Max Height and Max Width, No Arrow', () => {
		const styles = getInnerStylesForAlignment({maxHeight: 50, maxWidth: 50}, false, VERTICAL);
	...
	test('Max Height and Max Width, with Arrow', () => {
		const styles = getInnerStylesForAlignment({maxHeight: 50, maxWidth: 50}, true, VERTICAL);
