...
export const isMobile = ({screenSize}) => isScreenWidthInRange(screenSize, 0, 480);
export const isTablet = ({screenSize}) => isScreenWidthInRange(screenSize, 481, 1024);
export const isDesktop = ({screenSize}) => isScreenWidthInRange(screenSize, 1025, Infinity);
