...
export const getPublishState = value =>
	...
	render() {
		...
		const label =
			...
			t(
				...
				}${selected.toLowerCase()}.buttonLabel`,
				{ date: date && DateTime.format(date, DateTime.MONTH_ABBR_DAY) }
			);

		return (
			<div {...props} ref={this.ref} className={classNames}>
				<div className="publish-trigger-container">
					<span className="publish-trigger-text">{label}</span>
